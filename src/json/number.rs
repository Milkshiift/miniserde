...
impl Display for Number {
    fn fmt(&self, formatter: &mut fmt::Formatter) -> fmt::Result {
        match self {
            Self::U64(n) => formatter.write_str(itoa::Buffer::new().format(*n)),
            Self::I64(n) => formatter.write_str(itoa::Buffer::new().format(*n)),
            Self::F64(n) => formatter.write_str(ryu::Buffer::new().format(*n)),
        }
    }
}
...
impl Serialize for Number {
    fn begin(&self) -> Fragment {
        match self {
            Self::U64(n) => Fragment::U64(*n),
            Self::I64(n) => Fragment::I64(*n),
            Self::F64(n) => Fragment::F64(*n),
        }
    }
}
